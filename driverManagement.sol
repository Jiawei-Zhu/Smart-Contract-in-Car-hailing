...
contract DriverManagement{
    ...
    function JudgeString(string a, string b) internal returns (bool) {
    ...
    function ShowCredit(uint256 driver_index)returns(uint256){
    ...
    function GetDriverIndex(string id)public returns(uint256){
